...
| SDCC1 clock setup | Android4Lumia LK's MSM8960 clock table provides SDC rates including 400 kHz and 48 MHz, and `clock_config_mmc()` enables the named `sdcN_clk`; U-Boot currently mirrors only the 400 kHz identification rate and 48 MHz high-speed rate for SDCC1 until a real MSM8960 GCC driver exists. | `community/android4lumia-lk-msm8227/platform/msm8960/clock.c:333-347`, `community/android4lumia-lk-msm8227/platform/msm8960/acpuclock.c:209-241` | C/E, live-tested through U-Boot |
